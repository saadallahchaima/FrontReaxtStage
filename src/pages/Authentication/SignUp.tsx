...
import LogoDark from '../../images/logo_entreprise.png';
...
const SignUp: React.FC = () => {
  ...
  // Default role is set to 'MANAGER'
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    setLoading(true); // Set loading to true while sending request
